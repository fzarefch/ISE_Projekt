...
with tab2:
    ...
    with col2:
        ...
        fig_zip.update_layout(
            yaxis=dict(
                tickmode="array",  # Stelle sicher, dass jede Postleitzahl einzeln angezeigt wird
                title="Postleitzahl"
            ),
            xaxis=dict(title="Häufigkeit"),
            height=600  # Erhöhe die Höhe des Diagramms
        )
    ...
    st.plotly_chart(fig_restaurant, use_container_width=git --versionTrue)